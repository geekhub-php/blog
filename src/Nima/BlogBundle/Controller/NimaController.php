...
class NimaController extends Controller
{
  ...
  array(
    ...
    'date_post' => '1.12.2016', ), );
        ...
        return $this->render('NimaBlogBundle:Default:index.html.twig', array('data' => $movies));
    }
    ...
    public function showPostAction($id)
    {
        ...
        return $this->render('NimaBlogBundle:Default:showPost.html.twig', array('data' => $movies));
    }
    ...
    public function showMostReadAction()
    {
        ...
        return $this->render('NimaBlogBundle:Default:mostRead.html.twig', array('data' => $movies));
    }
